...
Deep dive: [CAP Theorem](../19-distributed-systems/01-cap-theorem.md)
...
Deep dive: [Consistency Models](../19-distributed-systems/02-consistency-models.md)
...
Deep dive: [Idempotency](../19-distributed-systems/03-idempotency.md)
...
Deep dive: [Outbox Pattern](../19-distributed-systems/04-outbox-pattern.md)
...
Deep dive: [Saga Pattern](../19-distributed-systems/05-saga-pattern.md)
...
Deep dive: [Distributed Transactions](../19-distributed-systems/06-distributed-transactions.md)
...
Deep dive: [Consensus — Raft and Paxos](../19-distributed-systems/07-consensus-raft-paxos.md)
...
Deep dive: [Clocks and Ordering](../19-distributed-systems/08-clocks-and-ordering.md)
...
1. **Payment service → Kafka**: use the [Outbox pattern](../19-distributed-systems/04-outbox-pattern.md). Single DB transaction writes the charge + an outbox row; a relay publishes the outbox row to Kafka with at-least-once semantics.
...
Deep dive: [Distributed Transactions](../19-distributed-systems/06-distributed-transactions.md) and [Idempotency](../19-distributed-systems/03-idempotency.md)
