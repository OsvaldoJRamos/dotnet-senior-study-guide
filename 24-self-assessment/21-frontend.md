...
Deep dive: [Promises vs Observables](../21-frontend/10-promises-vs-observables.md)
...
Deep dive: [Angular Performance](../21-frontend/12-angular-performance.md)
...
Deep dive: [SignalR with Angular](../21-frontend/13-signalr-with-angular.md)
...
Deep dive: [RxJS Fundamentals](../21-frontend/11-rxjs-fundamentals.md)
...
Deep dive: [Browser Rendering](../21-frontend/01-browser-rendering.md)
...
Deep dive: [DOM and Events](../21-frontend/02-dom-and-events.md)
...
Deep dive: [CDN](../21-frontend/03-cdn.md)
...
Deep dive: [iframes and Embedding](../21-frontend/04-iframes-and-embedding.md)
...
Deep dive: [Web Storage](../21-frontend/05-web-storage.md)
...
Deep dive: [Web Performance](../21-frontend/06-web-performance.md)
...
Deep dive: [PWA and Service Workers](../21-frontend/07-pwa-service-workers.md)
...
Deep dive: [SPA vs SSR vs SSG](../21-frontend/08-spa-ssr-ssg.md)
...
Deep dive: [Accessibility](../21-frontend/09-accessibility.md)
