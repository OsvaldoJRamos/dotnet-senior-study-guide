...
Deep dive: [IEnumerable vs IQueryable](../03-collections-and-linq/01-ienumerable-vs-iqueryable.md)
...
Deep dive: [Yield Return](../03-collections-and-linq/03-yield-return.md)
...
Deep dive: [ICollection, IList](../03-collections-and-linq/02-icollection-ilist.md)
...
Deep dive: [LinkedList vs List](../03-collections-and-linq/05-linkedlist-vs-list.md)
...
Deep dive: [Collections Overview](../03-collections-and-linq/04-collections-overview.md)
