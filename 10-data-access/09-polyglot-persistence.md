...
- ✅ Idempotent consumers handle at-least-once delivery safely (see [Idempotency and Race Conditions](../07-architecture-and-patterns/11-idempotency-and-race-conditions.md)).
...
- **No idempotency on consumers.** At-least-once delivery + non-idempotent consumer = duplicates in your read store. Always dedup (see [Idempotency and Race Conditions](../07-architecture-and-patterns/11-idempotency-and-race-conditions.md)).
