...
> For the catalog of which collection to pick when (concurrent and otherwise), see [Collections Overview](../03-collections-and-linq/04-collections-overview.md). This file focuses on **how the concurrent collections work** and the gotchas a senior is expected to know.
