...
- **Database locks are a completely separate beast** — process-boundary, escalation, multiple granularities. See [Database Locks](../11-data-access/07-database-locks.md).
