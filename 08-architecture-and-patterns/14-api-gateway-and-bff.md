...
- **Missing timeouts / circuit breakers.** A slow downstream cascades into a gateway/BFF thread exhaustion. Use [Polly](../10-aspnet-core/) or equivalent for resilience.
