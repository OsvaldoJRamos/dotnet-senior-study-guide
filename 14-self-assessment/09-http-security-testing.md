...
Deep dive: [HTTP Semantics](../09-http-and-web/01-http-semantics.md)
...
Deep dive: [REST API Design](../09-http-and-web/03-rest-api-design.md)
...
Deep dive: [Web Security](../09-http-and-web/04-web-security.md)
...
Deep dive: [Testing Pyramid](../10-testing/01-testing-pyramid.md)
...
Deep dive: [Mocking and Best Practices](../10-testing/02-mocking-and-best-practices.md)
...
Deep dive: [Stress and Load Testing](../10-testing/03-stress-and-load-testing.md)
