...
Deep dive: [Docker and Kubernetes](../08-devops/03-docker-and-kubernetes.md)
...
Deep dive: [Terraform](../08-devops/04-terraform.md)
...
Deep dive: [Azure Pipelines](../08-devops/05-azure-pipelines.md)
...
Deep dive: [FaaS](../08-devops/02-faas.md)
