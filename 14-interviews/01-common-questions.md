...
(See details in [Query Optimization](../07-data-access/04-query-optimization.md))
...
(See details in [Entity Framework](../07-data-access/02-entity-framework.md))
...
(See details in [Concurrency and Parallelism](../04-concurrency-and-parallelism/))
...
(See details in [API Resilience](../06-aspnet-core/04-api-resilience.md))
