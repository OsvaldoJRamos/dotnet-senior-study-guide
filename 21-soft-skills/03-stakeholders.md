...
The job isn't to pretend the conflict doesn't exist — it's to **name it, surface it to decision-makers, and record the decision** (usually as an [ADR](../07-architecture-and-patterns/17-design-docs-c4-adr.md)).
