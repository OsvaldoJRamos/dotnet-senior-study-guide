...
When you're considering adopting a new tool — a framework, database, language, messaging system, cloud service — walk through this list **in writing**, ideally as an [ADR](../07-architecture-and-patterns/17-design-docs-c4-adr.md).
...
- **Best tool for each job.** Taken literally, ends in polyglot hell. See [Polyglot Persistence](../10-data-access/09-polyglot-persistence.md) for the cost of every extra store.
