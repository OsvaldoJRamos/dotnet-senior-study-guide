...
All of these come back in [Memory and Performance](../04-memory-and-performance/README.md), where we cover the GC, LOH, memory optimization, and struct vs class tradeoffs.
