...
Deep dive: [Docker and Kubernetes](../13-devops/03-docker-and-kubernetes.md)
...
Deep dive: [Terraform](../13-devops/04-terraform.md)
...
Deep dive: [Azure Pipelines](../13-devops/05-azure-pipelines.md)
...
Deep dive: [AWS Load Balancers](../14-cloud/05-aws-load-balancers.md)
...
Deep dive: [Azure - Services](../14-cloud/03-azure-services.md)
...
Deep dive: [FaaS](../13-devops/02-faas.md)
...
Deep dive: [AWS Logging and Monitoring](../14-cloud/06-aws-logging-and-monitoring.md) | [Azure - Services](../14-cloud/03-azure-services.md)
...
Deep dive: [Git Essentials](../13-devops/06-git-essentials.md)
