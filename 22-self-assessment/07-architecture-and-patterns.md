...
Deep dive: [SOLID](../07-architecture-and-patterns/01-solid.md)
...
Deep dive: [Clean Architecture](../07-architecture-and-patterns/07-clean-architecture.md)
...
Deep dive: [CQRS](../07-architecture-and-patterns/08-cqrs.md)
...
Deep dive: [SAGA Pattern](../07-architecture-and-patterns/06-saga-pattern.md)
...
Deep dive: [Design Patterns](../07-architecture-and-patterns/02-design-patterns.md)
...
Deep dive: [KISS, DRY, YAGNI](../07-architecture-and-patterns/03-kiss-dry-yagni.md)
...
Deep dive: [Messaging](../07-architecture-and-patterns/10-messaging.md)
...
Deep dive: [Idempotency and Race Conditions](../07-architecture-and-patterns/11-idempotency-and-race-conditions.md)
...
Deep dive: [Anti-Patterns](../07-architecture-and-patterns/12-anti-patterns.md)
...
Deep dive: [Domain-Driven Design](../07-architecture-and-patterns/13-ddd.md)
...
Deep dive: [Event Sourcing](../07-architecture-and-patterns/15-event-sourcing.md)
...
Deep dive: [API Gateway and BFF](../07-architecture-and-patterns/14-api-gateway-and-bff.md)
...
Deep dive: [NFR-Driven Architecture](../07-architecture-and-patterns/18-nfr-driven-architecture.md)
...
Deep dive: [Design Docs, C4 and ADRs](../07-architecture-and-patterns/17-design-docs-c4-adr.md)
