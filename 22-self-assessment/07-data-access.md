...
Deep dive: [ORM vs Micro ORM vs ADO.NET](../10-data-access/01-orm-vs-microorm-vs-adonet.md)
...
Deep dive: [Entity Framework](../10-data-access/02-entity-framework.md)
...
Deep dive: [Query Optimization](../10-data-access/04-query-optimization.md)
...
Deep dive: [Databases](../10-data-access/03-databases.md)
...
Deep dive: [Transaction Isolation Levels](../10-data-access/06-transaction-isolation-levels.md)
...
Deep dive: [SQL Indexes](../10-data-access/05-sql-indexes.md)
...
Deep dive: [Database Locks](../10-data-access/07-database-locks.md)
...
Deep dive: [Execution Plans](../10-data-access/08-execution-plans.md)
...
- **Parameter sniffing**: the app and SSMS cached different plans because the first-run parameters were very different. The app's cached plan is terrible for the current parameters. Fix with `OPTION (RECOMPILE)`, `OPTIMIZE FOR`, or a plan guide — trade-offs in [Query Optimization](../10-data-access/04-query-optimization.md#parameter-sniffing-sql-server).
...
Deep dive: [Sharding and Partitioning](../10-data-access/10-sharding-and-partitioning.md)
...
Deep dive: [Replication and Read Replicas](../10-data-access/11-replication-and-read-replicas.md)
...
Deep dive: [Change Data Capture](../10-data-access/12-change-data-capture.md)
...
Deep dive: [Data Modeling](../10-data-access/13-data-modeling.md)
