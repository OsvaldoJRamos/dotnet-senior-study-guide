...
- **Using the outbox as an event store**: an outbox is *transient* — it holds outgoing messages until delivered. Event sourcing is a different pattern (see [Event Sourcing](../07-architecture-and-patterns/15-event-sourcing.md)).
