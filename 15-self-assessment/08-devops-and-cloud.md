...
Deep dive: [Docker and Kubernetes](../11-devops/03-docker-and-kubernetes.md)
...
Deep dive: [Terraform](../11-devops/04-terraform.md)
...
Deep dive: [Azure Pipelines](../11-devops/05-azure-pipelines.md)
...
Deep dive: [FaaS](../11-devops/02-faas.md)
...
Deep dive: [AWS Logging and Monitoring](../12-cloud/06-aws-logging-and-monitoring.md) | [Azure - Services](../12-cloud/03-azure-services.md)
