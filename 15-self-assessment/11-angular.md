...
Deep dive: [Promises vs Observables](../13-angular/01-promises-vs-observables.md)
...
Deep dive: [Angular Performance](../13-angular/03-angular-performance.md)
...
Deep dive: [SignalR with Angular](../13-angular/02-signalr-with-angular.md)
