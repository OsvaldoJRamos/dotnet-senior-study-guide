...
- **Missing timeouts / circuit breakers.** A slow downstream cascades into a gateway/BFF thread exhaustion. Use [Polly](../09-aspnet-core/) or equivalent for resilience.
